...
def load_theme_for_doc(doc: PresentationDoc, base_dir: Path, fallback_text) -> Theme:
...
def load_constraints_for_doc(
    doc: PresentationDoc, base_dir: Path, fallback_text: Optional[str]) -> Optional[ConstraintSet]:
