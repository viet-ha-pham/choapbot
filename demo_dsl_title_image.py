...
Run:
    python demo_dsl_title_image.py
...
.textbox, .bullets, .image { position: absolute; box-sizing: border-box; }
...
presentation "AI Strategy 2026":
  ...
  section "Bối cảnh":
    ...
    slide "Kiến trúc đề xuất":
      ...
      image:
        src: "E:\PERSONAL\Từ vựng sinh hoạt hằng ngày.png"
