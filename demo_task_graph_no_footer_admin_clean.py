...
6. Không tạo subtitle nếu subtitle chỉ là metadata như source heading, task id, layout, ontology, renderer. Không tạo footer. Bỏ qua hoàn toàn quốc hiệu/tiêu ngữ/Số văn bản/Nơi nhận/ký tá hành chính.
