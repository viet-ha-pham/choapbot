...
def build_graph():
    ...
    graph.add_edge("normalize_report_summary", "plan_slides_from_ontology_and_registry")
    graph.add_edge("plan_slides_from_ontology_and_registry", "render_pml_with_jinja")
    graph.add_edge("render_pml_with_jinja", "write_outputs")
